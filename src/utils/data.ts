...
const solutions = [
  {
    title: "Generate More Revenue with Strategic Digital Solutions",
    painPoint:
      "We enhance your business's digital presence with marketing strategies, custom web design, and SEO optimization.",
    agitatepainPoint:
      "Attract more customers, increase conversions, and generate revenue through an optimized digital channel with effective campaigns and the latest technology.",
    solution:
      "Don’t get left behind—upgrade your brand with powerful digital tools and start growing today! 🔎",
    img: visibilityDilemma,
  },
  {
    title: "Transform Your Business",
    painPoint:
      "We elevate your brand with services designed to maximize your digital impact.",
    agitatepainPoint:
      "From advanced SEO strategies and digital advertising to custom web design and effective branding, we help you stand out from the competition and increase conversions.",
    solution:
      " Get your digital brand today! 🤖",
    img: engagementGap,
  },
  {
    title: "Boost Your Business, No Matter the Industry",
    painPoint:
      "We adapt to your needs with tailored strategies in SEO and SEM, email marketing, AI, and content marketing.",
    agitatepainPoint:
      "No matter your industry, we create data-driven solutions to grow your project and maximize its digital potential.",
    solution:
      "Take the first step into the digital world and transform your brand today 🚀",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We are fully committed to your success. Our goal is not just to deliver services but to ensure you thrive. We focus on helping you grow, feel confident about your business, and maximize your benefits. When you win, we win.",
  },
  {
